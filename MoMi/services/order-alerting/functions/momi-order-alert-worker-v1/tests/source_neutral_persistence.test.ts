...
test("uses only source-neutral work, runtime, and alerting contracts", () => {
  ...
  assert.match(claim, /momi_runtime\.resolve_order_alert_worker_trigger_v1/)
  assert.match(claim, /momi_runtime\.resolve_order_alert_reader_trigger_v1/)
  assert.doesNotMatch(claim, /momi_runtime\.function_(trigger_)?registry/)
