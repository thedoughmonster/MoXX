...
create function momi_communications.capture_openai_message_v1(
...
begin
  ...
  values (item_id)
  on conflict (archive_item_id) do nothing
...
$$;
revoke all on function momi_communications.capture_openai_message_v1(
