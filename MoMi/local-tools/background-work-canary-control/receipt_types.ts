export type ReceiptEventType =
  | "activation_completed" | "canary_observation"
  | "cleanup_completed" | "deadman_reconciled"
  | "failure" | "fast_sample"
  | "guard_heartbeat" | "resource_sample"
  | "rollback_completed" | "rollback_started"
  | "run_completed" | "run_started"
  | "stop_requested" | "work_baseline"
...
export type ReceiptMetricKey =
  ...
  | "prior_cohort_membership_count" | "prior_cohort_membership_sha256"
  | "cohort_membership_addition_count" | "cohort_membership_addition_sha256"
  | "cohort_removed_member_count" | "cohort_removed_member_sha256"
  | "cohort_missing_lineage_edge_count" | "cohort_missing_lineage_edge_sha256"
  | "cohort_changed_parent_count" | "cohort_changed_parent_sha256"
  | "cohort_root_count"
  | "cohort_root_sha256"
  | "cron_history_bytes"
  | "database_bytes"
  ...
  | "duration_ms"
  | "error_class"
  | "failure_fingerprint" | "failure_reason" | "failure_stage"
  | "generation_sha256"
  | "exact_identity_mask"
  | "guard_active"
  | "guard_failures"
  ...
  | "missed_samples"
  | "inactive_after_mask"
  | "invariant_work_rejected" | "invariant_control_rejected"
  | "invariant_cohort_rejected" | "invariant_routes_rejected"
  | "invariant_safety_rejected"
  | "numbackends"
  | "oldest_age_seconds"
  | "observed_outer_keys"
