...
export async function startRecoveryCanary(state: RecoveryState): Promise<void> {
  ...
  await appendReceipt(state.receipt, { event_type: "work_baseline",
    timestamp_utc: new Date(preflight.observedAtUtcMs).toISOString(), metrics: {
      ...
      prior_cohort_membership_count: preflight.priorCohortMembershipCount,
      prior_cohort_membership_sha256: preflight.priorCohortMembershipSha256,
      cohort_membership_addition_count: preflight.cohortMembershipAdditionCount,
      cohort_membership_addition_sha256: preflight.cohortMembershipAdditionSha256,
      cohort_removed_member_count: preflight.cohortMissingPriorMemberCount,
      cohort_removed_member_sha256: preflight.cohortMissingPriorMemberSha256,
      cohort_changed_parent_count: preflight.cohortChangedParentCount,
      cohort_changed_parent_sha256: preflight.cohortChangedParentSha256,
      cohort_missing_lineage_edge_count: preflight.cohortMissingPriorLineageEdgeCount,
      cohort_missing_lineage_edge_sha256: preflight.cohortMissingPriorLineageEdgeSha256,
  ...
  await appendReceipt(state.receipt, { event_type: "activation_completed",
    timestamp_utc: new Date(activation.startedAtUtcMs).toISOString(), metrics: {
      ...
      prior_cohort_membership_count: activation.frozen.priorCohortMembershipCount,
      prior_cohort_membership_sha256: activation.frozen.priorCohortMembershipSha256,
      cohort_membership_addition_count: activation.frozen.cohortMembershipAdditionCount,
      cohort_membership_addition_sha256: activation.frozen.cohortMembershipAdditionSha256,
      cohort_removed_member_count: activation.frozen.cohortMissingPriorMemberCount,
      cohort_removed_member_sha256: activation.frozen.cohortMissingPriorMemberSha256,
      cohort_changed_parent_count: activation.frozen.cohortChangedParentCount,
      cohort_changed_parent_sha256: activation.frozen.cohortChangedParentSha256,
      cohort_missing_lineage_edge_count:
        activation.frozen.cohortMissingPriorLineageEdgeCount,
      cohort_missing_lineage_edge_sha256:
        activation.frozen.cohortMissingPriorLineageEdgeSha256,
