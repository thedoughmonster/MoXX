...
export function generateGuardBootstrapSql(value: unknown): string {
  ...
  return [
    ...
    "  latest_run_id bigint; final_run_id bigint; target_executions bigint;",
    "  guard_count bigint;",
    "  active_cron bigint; other_cron bigint;",
    ...
    "    raise exception 'momi_guard_bootstrap_history_gap'; end if;",
    ...
    `    where runid > ${input.startCronRunId} and runid <= latest_run_id`,
    "      and status = 'running' and jobid not in (2, 3, 4, 11);",
