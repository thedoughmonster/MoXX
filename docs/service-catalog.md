...
| decide | `momi.communications.evaluate_item.v1` | Evaluate one durable communication archive item with a configured model. | `communications-archive` | core_capability | momi_internal | `/functions/v1/momi-communications-evaluate-item-v1` |
