...
| --- | --- | --- | --- | --- | --- | --- |
| `agent-control` | retired | declared | not_asserted | none | none | none |
| `archive-governance` | active | implemented | not_asserted | none | none | none |
| `communications-archive` | active | unclassified | not_asserted | `momi.communications.capture_gateway_exchange.v1`, `momi.communications.capture_human_message.v1`, `momi.communications.capture_openai_message.v1`, `momi.communications.capture_operational_note.v1`, `momi.communications.get_gateway_exchange_receipt.v1`, `momi.raw_json.capture_evidence.v1`, `toast.archive.warehouse_projection_input.v1` | `momi-communications-capture-human-message-v1`, `momi-communications-capture-openai-message-v1` | none |
...
| `momi-event-routing` | active | unclassified | not_asserted | `momi.events.append.v1`, `momi.events.delivery_lifecycle.v1`, `momi.events.delivery_reference.v1`, `momi.events.delivery_witness.v1`, `momi.events.route.v1`, `momi.events.warehouse_append.v1`, `momi.events.warehouse_delivery_reservation.v1` | `momi-event-router-v1` | `cron_job:momi-event-delivery-retries-v1`, `cron_job:momi-event-routing-wakeup-v1`, `cron_job:momi-expired-delivery-reconcile-v1`, `event_subscription:order-alerting-v1`, `event_subscription:warehouse-projection-toast-v1`, `queue:order_alerting_v1`, `queue:order_alerting_v1_dead_letter`, `queue:warehouse_projection_toast_v1`, `queue:warehouse_projection_toast_v1_dead_letter` |
...
| `runtime-registry` | active | implemented | not_asserted | `momi.runtime.active_trigger_resolution.v1` | none | none |
