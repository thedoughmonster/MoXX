...
test("maps active deployment authority to MoXX", () => {
  const contract = read("MoMi/tests/deployment_authority.test.ts")
  assert.match(contract, /thedoughmonster\/MoXX\/\.github\/workflows\/deploy-dev/)
