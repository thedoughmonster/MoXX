...
Give this reader a Dough Monster payment ID and an approved read token, and it
returns the newest clean payment record.
...
The response contains the canonical payment document, stable entity identity,
...
payments, and internal read failures have distinct responses.
