...
Give this reader a Dough Monster menu entity ID and an approved read token, and
it returns the newest clean menu record.
...
The response contains the canonical menu document, stable entity identity,
...
Invalid or unauthorized requests are rejected. Inactive contracts, missing menu
entities, and internal read failures have distinct responses.
