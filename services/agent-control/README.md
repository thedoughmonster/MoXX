...
change authority. Its retired manifest preserves only the ownership inventory
needed to validate the seven immutable migrations already applied to the shared
development history. See `docs/agent-control-relocation.md`.
