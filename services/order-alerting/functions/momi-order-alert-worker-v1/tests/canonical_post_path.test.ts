...
const job: ClaimedWork = {
  ...
  source_system: "toast", source_version_id: "warehouse-version",
        ...
        const api = await callOrderApi(job, "https://project.supabase.co",
          ...
          (_url, init) => {
            ...
            return Promise.resolve(Response.json({ ok: true,
              contract_key: canonicalOrderContractKey, contract_version: 1,
              trace_id: "8de3df64-33f5-4d1f-9569-f6786798f182",
              work_id: readCapability.work_id, order_id: orderId,
              schema_version: 1,
              order_document: { id: orderId,
                location_id: "97c5ae65-901a-45f6-b623-8b018df3bf91" },
              order_presentation: { presentation_version: 1,
                display_number: "42", fulfillment_at: null,
                fulfillment_epoch: null, item_count: 0,
